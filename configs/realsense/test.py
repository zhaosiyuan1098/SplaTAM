...
scenes = ["test","test2","test3","test4","test5"]
primary_device="cuda:0"
seed = 1
scene_name = scenes[2]

base_dir = "./experiments/d435_test" # Root Directory to Save iPhone Dataset
scene_name = "test001" # Scan Name
num_frames = 51 # Desired number of frames to capture
